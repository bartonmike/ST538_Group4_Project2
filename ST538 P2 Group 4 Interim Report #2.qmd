...
This seems to be doing worse than our tuned forest, looking at our AUC score, we get 0.5274 which confirms it.
...
Looking at the different thresholds, we can see that 0.10 and 0.15 give better results for the imbalanced data. We can explore this further. We may also want to revert back to a LASSO or something similar to try and sift out any variables that might have too much overlap and not be contributing.



## NEAR FUTURE DIRECTIONS

Directions for next week: We may consider SMOTE or downsampling to comabat the imbalance in the data. https://www.geeksforgeeks.org/machine-learning/how-to-use-smote-for-imbalanced-data-in-r/
