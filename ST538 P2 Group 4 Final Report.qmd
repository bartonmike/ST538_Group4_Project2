...
#   1 1396 1738
```
The resulting model showed a better balance of true positives and true negatives..
...
```{r}
#| label: randomforest-model-setup
#| echo: FALSE
#| include: FALSE
#| eval: FALSE
...
```{r}
#| label: test-data-model1-static-table
...
```{r}
#| label: test-data-model2-static-table
