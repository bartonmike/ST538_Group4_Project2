...
# splitting into train/not_train
sample <- sample(c(TRUE, FALSE), nrow(train_dat), replace=TRUE, prob=c(train_percent,not_train_percent))
...
validation  <- not_training[sample, ]
testing   <- not_training[!sample, ]
