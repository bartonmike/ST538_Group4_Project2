...
\begin{frame}{Findings: XGBoost Method}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{figs/xgboost_performace.png}
      \caption{XGBoost Model Accuracy}
      \label{fig:XGBoost Model Accuracy}
    \end{figure}
...
%---------------------------------------------------------Slide 8
%Slide 8
%Thanks: Image of an Crater Lake

\setLayout{blank} % Example of changing layout

\setbeamertemplate{background} 
{
    \includegraphics[width=\paperwidth,height=\paperheight]{figs/craterlake.jpeg}
}

\begin{frame}{Thanks}

%\includegraphics[scale=0.4]{figs/craterlake.jpeg}
